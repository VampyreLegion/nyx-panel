...
MACHINES = {
    ...
    "astraea": {
        ...
        "services": [
            ...
            {"name": "livingart-web-1","type": "docker",  "label": "Living Art Web", "desc": "Living Art display frontend — generative art on :8090",                       "url": "https://art.nyxstudios.net"},
            {"name": "livingart-api-1","type": "docker",  "label": "Living Art API", "desc": "Living Art backend API — serves art data to the web container",                "url": None},
        ],
    },
    "selene": {
        "label": "Selene",
...
TUNNELS = [
    ...
    {"host": "nyx.nyxstudios.net",     "machine": "nyx",      "backend": "192.168.1.236:7000",  "service": "Odysseus AI workspace",        "auth": "Access"},
    {"host": "dgx.nyxstudios.net",     "machine": "nyx",      "backend": "192.168.1.236:11001", "service": "DGX Dashboard (nginx proxy → :11000)", "auth": "Access"},
    ...
    {"host": "nyxnotes.nyxstudios.net","machine": "nyx",      "backend": "192.168.1.236:8502",  "service": "Open Notebook UI (nyxnotes)",  "auth": "Access"},
    {"host": "notebook.nyxstudios.net","machine": "nyx",      "backend": "192.168.1.236:8502",  "service": "Open Notebook UI (alias)",     "auth": "Access"},
]
