...
MACHINES = {
    "nyx": {
        ...
        "services": [
            ...
            {"name": "living-art-web-1","type": "docker",  "label": "Living Art Web",   "desc": "Living Art display frontend — generative art on :80",                          "url": "https://art.nyxstudios.net"},
            ...
            {"name": "artadmin",        "type": "systemd", "label": "Living Art Admin",  "desc": "Living Art Admin — management UI on :80, requires Cloudflare Access",          "url": "https://artadmin.nyxstudios.net"},
...
TUNNELS = [
    ...
    {"host": "art.nyxstudios.net",              "machine": "Nyx",     "backend": "192.168.1.236:80",   "service": "Living Art display frontend",      "auth": "Public"},
    {"host": "artadmin.nyxstudios.net",         "machine": "Nyx",     "backend": "192.168.1.236:80",   "service": "Living Art admin UI",              "auth": "Cloudflare Access"},
